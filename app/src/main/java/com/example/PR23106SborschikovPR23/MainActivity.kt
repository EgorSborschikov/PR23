...
fun BottomNavigationBar(navController: NavHostController) {
    BottomNavigation {
        BottomNavigationItem(
            ...
            label = { Text("Анализы") },
            selected = false,
            onClick = { navController.navigate("analyzes") }
        )
        // Добавьте другие элементы навигации
    }
}
...
fun Navigation() {
    ...
    NavHost(navController, startDestination = "analyzes") {
        composable("analyzes") { AnalyzesScreen(newsList = emptyList(), yourDataList = emptyList()) }
